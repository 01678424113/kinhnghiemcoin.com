...
class tds_icon_box3 extends tds_api {
    ...
    private function get_css() {
        ...
        $td_css_compiler->load_setting_raw( 'icon_vertical_space', $this->get_style_att( 'icon_vertical_space' ) . 'px' );
        $td_css_compiler->load_setting_raw( 'icon_horizontal_space', $this->get_style_att( 'icon_horizontal_space' ) . 'px' );
