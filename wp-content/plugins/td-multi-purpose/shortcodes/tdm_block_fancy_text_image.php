...
class tdm_block_fancy_text_image extends td_block {
    ...
    public function get_custom_css() {
        ...
        // text1_color
        td_block::load_color_settings( $this, $td_css_compiler, 'text1_color', 'text1_color_solid', 'text1_color_gradient', 'text1_color_gradient_1' );
        // text2_color
        td_block::load_color_settings( $this, $td_css_compiler, 'text2_color', 'text2_color_solid', 'text2_color_gradient', 'text2_color_gradient_1' );
