    ...
    if ( $oldies ) {
        ...
        foreach ( $oldies as $old ) {
            ...
            if ( $oldpermalink ) {
                ...
                //post/page not found, perhaps deleted?
            }
...
if ( isset( $_POST['submit_dbupdates'] ) && $_POST['submit_dbupdates'] ) {
    ...
    $this->log( __( 'Finished running database create/update routines', 'seo-booster' ) );
}
...
?></textarea>
						<p class="description"><?php 
_e( 'Enter keywords to be filtered out. Separate keywords with comma or linebreak. Applies to the ', 'seo-booster' );
?>
					</p>
				</td>
			</tr>
...
?>/>
					<p><label for="seobooster_dynamic_tagging"><?php 
...
?>/>
					<p><label for="seobooster_dynamic_tagging_related"><?php 
...
?>/>
			<p><label for="seobooster_dynamic_tag_assigncpts"><?php 
...
?>
	...
	<td>
		<input type="text" id="seobooster_dynamic_tag_minlength" name="seobooster_dynamic_tag_minlength" value="<?php 
echo  $dynamic_tag_minlength ;
?>" class="regular-text code" />
		<label for="seobooster_dynamic_tag_minlength"><?php 
...
<td>
	<input type="text" id="seobooster_dynamic_tag_maxlength" name="seobooster_dynamic_tag_maxlength" value="<?php 
echo  $dynamic_tag_maxlength ;
?>" class="regular-text code" />
	<label for="seobooster_dynamic_tag_maxlength"><?php 
...
<td>
	<input type="text" id="seobooster_dynamic_tag_maximum" name="seobooster_dynamic_tag_maximum" value="<?php 
...
?>/>
		<label for="seobooster_weekly_email"><?php 
...
?>" class="regular-text">
	<label for="seobooster_weekly_email_recipient"><?php 
...
?>/>
		<label for="seobooster_debug_logging"><?php 
...
?>/>
		<label for="seobooster_delete_deactivate"><?php 
...
?>
					<label class="description" for="reset_guided_tours"><?php 
