...
?></h3>
		<input type="checkbox" name="hideinternal" id="hideinternal"><label for="hideinternal"><?php 
_e( 'Hide internal searches', 'seo-booster' );
?></label>

		<form role="form" id="keywordsfilter">
			<label class="radio-inline"><input type="radio" name="showkws" value="all" checked><?php 
